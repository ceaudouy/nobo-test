...
function InfoMovie(detail, casting) {
	...
	return (
		<div>
			<ExpansionPanel className="watch-card">
...
export default function Watch() {
	...
	var info = 'https://api.themoviedb.org/3/movie/' + movie + '?api_key=b936c3df071b03229069cfcbe5276410&language=' + langue;
	var cast = 'https://api.themoviedb.org/3/movie/' + movie + '/credits?api_key=b936c3df071b03229069cfcbe5276410';
	...
	return (
		<div className="watch-all">
			<img className="image" src={"http://image.tmdb.org/t/p/w185/" + detail.poster_path} alt="" />
